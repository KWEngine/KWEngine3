...
namespace KWEngine3TestProject.Worlds
{
    public class GameWorldJumpAndRunPhysics : World
    {
        ...
        public override void Prepare()
        {
            ...
            f02.SetScale(3, 1, 1);
            f02.SetColliderType(ColliderType.ConvexHull);
            ...
            w01.SetScale(1, 10, 1);
            w01.SetColliderType(ColliderType.ConvexHull);
            ...
            w02.SetScale(1, 10, 1);
            w02.SetColliderType(ColliderType.ConvexHull);
            ...
            w03.SetColliderType(ColliderType.ConvexHull);
