...
void main()
{
    ...
    vec4 colorSmallerTex = sampleTent(uTextureSmaller, txSmall, 1.0) * (0.33 + uBloomRadius); 
    vec4 colorBiggerTex = sampleTent(uTextureBigger, txBig, 1.0) * (0.25 + (1.0 - uBloomRadius));
