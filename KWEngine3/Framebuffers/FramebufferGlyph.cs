...
namespace KWEngine3.Framebuffers
{
    internal class FramebufferGlyph : Framebuffer
    {
        ...
        public override void Init()
        {
            ...
            Attachments.Add(new FramebufferTexture(FramebufferTextureMode.RGBA16UI, _size.X, _size.Y, 1, TextureMinFilter.Linear, TextureMagFilter.Linear, TextureWrapMode.ClampToEdge));   // Color/Alpha
