...
namespace KWEngine3.Framebuffers
{
    internal class FramebufferBloom : Framebuffer
    {
        ...
        {
            Bind(false);
            Attachments.Add(new FramebufferTexture(FramebufferTextureMode.RGBA8, _size.X, _size.Y, 0, TextureMinFilter.Linear, TextureMagFilter.Linear, TextureWrapMode.ClampToEdge, false, false)); // Color1
            SizeInBytes = _size.X * _size.Y * 4;
