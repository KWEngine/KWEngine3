...
{
    internal class RendererLightingPassLQ : IRenderer
    {
        ...
        public void Init()
        {
            if (ProgramID < 0)
            {
                ...
                string resourceNameVertexShader = "KWEngine3.Shaders.LowQuality.shader.lighting.gbufferLQ.vert";
                string resourceNameFragmentShader = "KWEngine3.Shaders.LowQuality.shader.lighting.gbufferLQ.frag";
