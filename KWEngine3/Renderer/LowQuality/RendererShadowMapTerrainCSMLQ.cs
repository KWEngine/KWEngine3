...
{
    internal class RendererShadowMapTerrainCSMLQ : IRenderer
    {
        ...
        public void Init()
        {
            if (ProgramID < 0)
            {
                ...
                string resourceNameVertexShader = "KWEngine3.Shaders.LowQuality.shader.msm16terrain_csmLQ.vert";
                string resourceNameGeometryShader = "KWEngine3.Shaders.LowQuality.shader.msm16terrain_csmLQ.geom";
                string resourceNameTesselationControlShader = "KWEngine3.Shaders.LowQuality.shader.msm16terrain_csmLQ.tesc";
                string resourceNameTesselationEvaluationShader = "KWEngine3.Shaders.LowQuality.shader.msm16terrain_csmLQ.tese";
                string resourceNameFragmentShader = "KWEngine3.Shaders.LowQuality.shader.msm16terrain_csmLQ.frag";
