...
{
    internal class RendererShadowMapLQ : IRenderer
    {
        ...
        public void Init()
        {
            if (ProgramID < 0)
            {
                ...
                string resourceNameVertexShader = "KWEngine3.Shaders.LowQuality.shader.msm16LQ.vert";
                string resourceNameFragmentShader = "KWEngine3.Shaders.LowQuality.shader.msm16LQ.frag";
