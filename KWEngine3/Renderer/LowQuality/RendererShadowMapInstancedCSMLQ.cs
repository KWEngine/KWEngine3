...
{   
    internal class RendererShadowMapInstancedCSMLQ : IRenderer
    {
        ...
        public void Init()
        {
            if (ProgramID < 0)
            {
                ...
                string resourceNameVertexShader = "KWEngine3.Shaders.LowQuality.shader.msm16instanced_csmLQ.vert";
                string resourceNameGeometryShader = "KWEngine3.Shaders.LowQuality.shader.msm16instanced_csmLQ.geom";
                string resourceNameFragmentShader = "KWEngine3.Shaders.LowQuality.shader.msm16instanced_csmLQ.frag";
