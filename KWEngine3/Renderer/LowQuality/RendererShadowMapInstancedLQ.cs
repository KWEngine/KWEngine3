...
{
    internal class RendererShadowMapInstancedLQ : IRenderer
    {
        ...
        public void Init()
        {
            if (ProgramID < 0)
            {
                ...
                string resourceNameVertexShader = "KWEngine3.Shaders.LowQuality.shader.msm16instancedLQ.vert";
                string resourceNameFragmentShader = "KWEngine3.Shaders.LowQuality.shader.msm16instancedLQ.frag";
