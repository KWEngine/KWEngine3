...
{
    internal class RendererShadowMapCubeInstancedLQ : IRenderer
    {
        ...
        public void Init()
        {
            if (ProgramID < 0)
            {
                ...
                string resourceNameVertexShader = "KWEngine3.Shaders.LowQuality.shader.msm16.cubeinstancedLQ.vert";
                string resourceNameGeometryShader = "KWEngine3.Shaders.LowQuality.shader.msm16.cubeinstancedLQ.geom";
                string resourceNameFragmentShader = "KWEngine3.Shaders.LowQuality.shader.msm16.cubeinstancedLQ.frag";
