...
namespace KWEngine3.Helper
{
    ...
    internal class HelperDDS : IDisposable
    {
        ...
        private HelperDDS(SKBitmap bitmap)
        {
        ...
        /// </summary>
        public SkiaSharp.SKBitmap BitmapImage
        {
        ...
        #region Operators
        public static implicit operator HelperDDS(SKBitmap value)
        {
            return new HelperDDS(value);
        }

        public static explicit operator SKBitmap(HelperDDS value)
        {
