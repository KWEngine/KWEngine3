...
{
    internal partial class KWBuilderOverlay : IDisposable
    {
        ...
        public KWBuilderOverlay(int width, int height)
        {
            _windowWidth = width;
        ...
        public void RecreateFontDeviceTexture()
        {
            ...
            {
                GL.TexImage2D(TextureTarget.Texture2D, i, PixelInternalFormat.Rgba8, widthTmp, heightTmp, 0, PixelFormat.Bgra, PixelType.UnsignedByte, IntPtr.Zero);
                widthTmp = Math.Max(1, widthTmp / 2);
                heightTmp = Math.Max(1, heightTmp / 2);
            }
