...
namespace KWEngine3.Assets
{
    internal static class KWTerrainQuad
    {
        ...
        private static float multiplier = KWEngine.TERRAIN_PATCH_SIZE;
        ...
        public static void Init()
        {
            ...
            _vertices = new float[]
            {
                ...
                -0.5f * multiplier, 0f, -0.5f * multiplier, // left back
                -0.5f * multiplier, 0f, +0.5f * multiplier, // left front
                +0.5f * multiplier, 0f, +0.5f * multiplier, // right front
            };
